    ...
    public class StripeController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreatePayment([FromBody] CreatePaymentRequest request)
        {
            ...
            if (payment != null)
            {
                ...
                payment.CreatedAt = DateTime.UtcNow; // Or UpdatedAt if you have it
                // payments table doesn't seem to have IdempotencyKey based on previous view? 
                // Using the properties visible in previous view: Entity has BookingId, Amount, Currency, PaymentMethod, Status, PaymentIntentId, ClientSecret, CreatedAt.
            ...
            else
            {
                ...
                // Keep the booking/payment logic
            }
            ...
            try
            {
                ...
                {
                    Payment = payment, // Use navigation property to let EF Core handle ID generation order
                    Provider = "Stripe",
                    EventId = pi.Id,
